...
$controler = new ManagementControler();
if (!$controler->is_cookie_auth()){exit(0);}
/*!
 * upload demo for php
 * @requires xhEditor
 *
...
$upExt='txt,rar,zip,jpg,jpeg,gif,png,swf,wmv,avi,wma,mp3,mid,pdf,doc,docx';//上传扩展名
$msgType=2;//返回上传参数的格式：1，只返回url，2，返回参数数组
$immediate=isset($_GET['immediate'])?$_GET['immediate']:0;//立即上传模式，仅为演示用
ini_set('date.timezone','America/New_York');//时区
